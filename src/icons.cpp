...
const unsigned int N_COUNTRY = sizeof(CountryFlags) / sizeof(struct CountryFlags_t);

struct SettingIcons_t SettingIcons[] =
{
...
const unsigned int N_SETTINGS = sizeof(SettingIcons) / sizeof(struct SettingIcons_t);
